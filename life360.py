...
class life360:
    ...
    def make_request(self, url, params=None, method='GET', authheader=None):
        ...
        if method == 'GET':
            try:
                ...
                print("Timed out")
                self.make_request(self, url, params=None,
                                  method='GET', authheader=None)
        ...
        try:
            ...
            print(
                f"There has been an issue connecting to life360's servers! | {E}")
    ...
    def get_circle_members(self, circle_id):
        authheader = "bearer " + self.access_token
        r = self.make_request(url=f"https://api-cloudfront.life360.com/v4/circles/{circle_id}/members".format(
            circle_id=circle_id), method="GET", authheader=authheader)["members"]
        return r

    def get_circle_places(self, circle_id):
        authheader = "bearer " + self.access_token
        r = self.make_request(url=f"https://api-cloudfront.life360.com/v4/circles/{circle_id}/places".format(
            circle_id=circle_id), method="GET", authheader=authheader)["places"]
        return r
